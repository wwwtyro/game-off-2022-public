...
const tips = [
  ...
  "Missiles are ten times more powerful than beams and fire 1/10th as frequently for the same number of upgrades, but they do not need to be aimed and they have 50% more targeting range.",
